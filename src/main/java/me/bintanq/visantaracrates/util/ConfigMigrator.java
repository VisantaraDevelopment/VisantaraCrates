...
public final class ConfigMigrator {
     ...
     */
    public static void migrateConfig(VisantaraCrates plugin) {
        try {
     ...
     * @param plugin the plugin instance
     */
    public static void migrateRarities(VisantaraCrates plugin) {
        try {
     ...
     * @param plugin the plugin instance
     */
    public static void migrateCrateFiles(VisantaraCrates plugin) {
        try {
