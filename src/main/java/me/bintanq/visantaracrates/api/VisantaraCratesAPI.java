package me.bintanq.visantaracrates.api;

import me.bintanq.visantaracrates.VisantaraCrates;
import me.bintanq.visantaracrates.api.dto.*;
import me.bintanq.visantaracrates.api.event.*;
...
/**
 * VisantaraCratesAPI — the stable, public-facing developer API.
 *
 ...
 * <h3>Usage</h3>
 * <pre>{@code
 * VisantaraCratesAPI api = VisantaraCratesAPI.getInstance();
 * api.giveKeys(player, "example_key", 5);
 * }</pre>
 *
 * @since 1.4.0
 */
public final class VisantaraCratesAPI {

    private static VisantaraCratesAPI instance;

    private final VisantaraCrates plugin;

    private VisantaraCratesAPI(VisantaraCrates plugin) {
        this.plugin = plugin;
    }
     ...
     *
     * @param plugin the VisantaraCrates plugin instance
     */
    public static void init(VisantaraCrates plugin) {
        instance = new VisantaraCratesAPI(plugin);
    }
     ...
     */
    public static VisantaraCratesAPI getInstance() {
        return instance;
    }
     ...
     *
     * @return the current VisantaraCrates version
     */
