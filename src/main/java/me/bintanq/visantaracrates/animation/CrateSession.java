...
public class CrateSession {
    ...
    private RewardResult overriddenResult = null;

    public Player      getPlayer()       { return player; }
    public Crate       getCrate()        { return crate; }
    public RewardResult getResult()      { return overriddenResult != null ? overriddenResult : result; }
    public void        setResult(RewardResult result) { this.overriddenResult = result; }
